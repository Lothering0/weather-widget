...
.ww-icon {
  ...
  background-image: url("https://cdn.jsdelivr.net/gh/Lothering0/weather-widget@latest/src/assets/icons/weather_icons.svg");
  ...
  &.#{$icon}-04d,
  &.#{$icon}-04n {
    background-image: url("https://cdn.jsdelivr.net/gh/Lothering0/weather-widget@latest/src/assets/icons/double_cloud.svg");
